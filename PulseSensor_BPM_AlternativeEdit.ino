...
const int THRESHOLD = 700;   // Adjust this number to avoid noise when idle

/* Wifi setup */
const char ssid[] = "UWMVisitor"; 
const char pass[] = "panthers20"; 
byte mac[6];
        ...
        */
        if (pulseSensor.sawStartOfBeat()) {
          if(client.available() > 0) {
            server.write("♥  A HeartBeat Happened ! "); 
            client.flush(); 
            server.write("BPM: ");
            client.flush();                       
            server.print(myBPM);
